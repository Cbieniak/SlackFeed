class ApplicationController < ActionController::Base
  ...
  protect_from_forgery with: :exception
	...
	require 'open-uri'
 def index
 	channel_data = JSON.load(open("https://slack.com/api/channels.list?token=xoxp-2182263167-2213146441-2494958940-5d527f&pretty=1"))
	...
	@user_channel_ids.each do |channel_id|
		...
		message_data = JSON.load(open("https://slack.com/api/channels.history?token=xoxp-2182263167-2213146441-2494958940-5d527f&channel=#{channel_id}&oldest=#{time-3600}&count=10"))
		puts message_data
